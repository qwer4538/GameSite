...
<%
	...
	Vector vResult= regMgr.recvMsg(userid);
...
<div class="row text-center" style="width:100%; margin-top:100px;">
	<div style="width: 100%">
		<button type="button" class="btn btn-link"><img src="img/recvmsg.png" width="20" height="20" alt="recv" title="recv" /><a href="MsgList.jsp"><b>&nbsp;받은쪽지함</b></a></button>
    ...
    <tr>
      	...
      	<td><%=msgBean.getSend_id()%></td>
      	<td style="text-overflow:ellipsis;"><a href="MsgRead.jsp?idx=<%=msgBean.getIdx()%>"><%=msgBean.getContent()%></a></td>
